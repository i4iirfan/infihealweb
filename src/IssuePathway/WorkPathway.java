...
public class WorkPathway extends BaseClassIssuePathway {
    @Test
    public void pathway() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(40));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//button[@title='Work']")));
        driver.findElement(By.xpath(".//button[@title=\"Work\"]")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//p[contains(text(),'professional life')]")));
        driver.findElement(By.xpath(".//input[@placeholder='Type your message']")).sendKeys("My work life balance is not good there is a lot of pressure on me");
        ...
        driver.findElement(By.xpath("(.//div[contains(text(),'might be bothering')])[1]")).click();
