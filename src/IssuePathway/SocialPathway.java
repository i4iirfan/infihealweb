...
public class SocialPathway extends BaseClassIssuePathway {
    @Test
    public void pathway() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(40));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//button[@title='Social']")));
        driver.findElement(By.xpath(".//button[@title=\"Social\"]")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//p[contains(text(),'hampering your')]")));
        driver.findElement(By.xpath(".//input[@placeholder='Type your message']")).sendKeys("my instagram followers have been");
