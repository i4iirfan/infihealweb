...
public class RelationshipPathway extends BaseClassIssuePathway {
    @Test
    public void pathway() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(40));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//button[@title='Relationship']")));
        driver.findElement(By.xpath(".//button[@title=\"Relationship\"]")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//p[contains(text(),'interfering with')]")));
        driver.findElement(By.xpath(".//input[@placeholder='Type your message']")).sendKeys("my relationship is not good ");
