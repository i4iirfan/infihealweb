...
public class SchoolCollegePathway extends BaseClassIssuePathway{
    @Test
    public void pathway() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(40));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//button[@title='School/College']")));
        driver.findElement(By.xpath(".//button[@title=\"School/College\"]")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//p[contains(text(),'academics')]")));
        driver.findElement(By.xpath(".//input[@placeholder='Type your message']")).sendKeys("I am not getting good result ");
        ...
        driver.findElement(By.xpath(".//button[@Title='Send']")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//p[contains(text(),'fulfilling social duties')]")));
