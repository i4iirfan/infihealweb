...
public class ChatBotTest extends map {
    WebDriver driver;
    WebElement input;
    ...
    /* public BaseTest(WebElement buttonElement, WebElement yesWithText, WebElement ummyeah) {
         this.buttonElement = buttonElement;
         this.yesWithText = yesWithText;
         this.ummyeah = ummyeah;
     }*/
    @BeforeClass
    public void setUp() {
